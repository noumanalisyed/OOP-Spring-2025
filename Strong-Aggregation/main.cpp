...
int main() {
/* Heart heart; heart.print(); Brain brain; brain.print();*/
    Person person1;
    cout<<endl<<endl;
    Person person2("For Person Brain","For Person Heart");
    cout<<endl<<endl;
    Person person3(100,"Kashif","New Message For Brain","New Message For Heart");
